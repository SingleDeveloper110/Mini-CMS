...
function EffectShowcase({ slider, extendParams, on }) {
  extendParams({
    showcaseEffect: {
      scale: 0.8,
      overlay: true,
...
function EffectCreative({ slider, extendParams, on }) {
  extendParams({
    creativeEffect: {
      prev: {},
      next: {},
...
function Thumbs({ slider, extendParams, on }) {
  extendParams({
    thumbs: {
      slider: null,
...
exports.DriftSlider = DriftSlider;
...
exports.EffectShowcase = EffectShowcase;
exports.Keyboard = Keyboard;
exports.Navigation = Navigation;
exports.Pagination = Pagination;
exports.ScrollAos = ScrollAos;
exports.Thumbs = Thumbs;
exports.default = DriftSlider;
